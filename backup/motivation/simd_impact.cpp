...
void *run(void *arg)
{
  ...
  ///////////////////////Generate the byte-level data format..///////////////////////////////////////	
      ...
      size_t ret  = posix_memalign((void**)&data_commitdate, 128, T1_len);   
	  if (ret) {
            printf ( "&data_commitdate_posix_memalign: %s\n", strerror(ret) );
            return NULL;
         }
  ...
  ///////////////////////Generate the byte-level data format..///////////////////////////////////////	
	...
	for (i = 0; i < T1_len; i++)
	{
      data_commitdate[i] = (2*i+3*i*i)%256;
	  data_for_scan[i] = FLIP( static_cast<ByteUnit>(data_commitdate[i]) );
	}
   ...
   ///////////////////////first barrier.....///////////////////////
    ...
    ///////////////////////second barrier...../////////////////////		
	 ...
	 {   
		...
		{
            bool real  = (data_commitdate[ii] > constant); 
      ...
      ///////////////////////second barrier...../////////////////////			
		...
		if (d->thread == 0) {
			...
			printf("byte-level predicate, threads: %d, codes_per_ns: %6.3f\n", d->threads,
