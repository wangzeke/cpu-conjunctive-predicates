...
*/
  ...
  ///////////////////////Generate the input output data..///////////////////////////////////////	
	...
	ByteUnit *data_1[4], *data_2[4], *data_3[4], *data_4[4]; //*data_2[4];  //compressed to byte boundary.
...
*/	
  ...
  {	
    ...
    ///////////////////////second barrier.to sync all the threads then begin to execute the code./////////////////////		
	  ...
	  if (p_s_model == 0)
        four_columns_cmp_with_literal_nP_nS(bitvector, T1_len, 
...
/*	  else if (p_s_model == 2)
        ...
        four_columns_cmp_with_literal_pf_nP_nS(data_, bitvector, T1_len, 
                                            ...
                                            literal_4, kNumBytesPerCode_4, kNumPaddingBits_4
								         );  
	  else if (p_s_model == 5)
        four_columns_cmp_with_literal_pf_nP_S(data_, bitvector, T1_len, 
                                            literal_1, kNumBytesPerCode_1, kNumPaddingBits_1,
                                            literal_2, kNumBytesPerCode_2, kNumPaddingBits_2,
                                            literal_3, kNumBytesPerCode_3, kNumPaddingBits_3,
                                            literal_4, kNumBytesPerCode_4, kNumPaddingBits_4
        ...
        four_columns_cmp_with_literal_pf_P_nS(data_, bitvector, T1_len, 
                                            literal_1, kNumBytesPerCode_1, kNumPaddingBits_1,
                                            literal_2, kNumBytesPerCode_2, kNumPaddingBits_2,
                                            literal_3, kNumBytesPerCode_3, kNumPaddingBits_3,
                                            literal_4, kNumBytesPerCode_4, kNumPaddingBits_4
        ...
        four_columns_cmp_with_literal_pf_P_S(data_, bitvector, T1_len, 
                                            literal_1, kNumBytesPerCode_1, kNumPaddingBits_1,
                                            literal_2, kNumBytesPerCode_2, kNumPaddingBits_2,
                                            literal_3, kNumBytesPerCode_3, kNumPaddingBits_3,
                                            literal_4, kNumBytesPerCode_4, kNumPaddingBits_4
        ...
        four_columns_cmp_with_literal_pf_or_nP_nS(data_, bitvector, T1_len, 
                                            literal_1, kNumBytesPerCode_1, kNumPaddingBits_1,
                                            literal_2, kNumBytesPerCode_2, kNumPaddingBits_2,
                                            literal_3, kNumBytesPerCode_3, kNumPaddingBits_3,
                                            literal_4, kNumBytesPerCode_4, kNumPaddingBits_4
        ...
        four_columns_cmp_with_literal_pf_or_nP_S(data_, bitvector, T1_len, 
                                            literal_1, kNumBytesPerCode_1, kNumPaddingBits_1,
                                            literal_2, kNumBytesPerCode_2, kNumPaddingBits_2,
                                            literal_3, kNumBytesPerCode_3, kNumPaddingBits_3,
                                            literal_4, kNumBytesPerCode_4, kNumPaddingBits_4
	  ...
	  else if (p_s_model == 10)
        four_columns_cmp_with_literal_pf_or_P_nS(data_, bitvector, T1_len, 
                                            literal_1, kNumBytesPerCode_1, kNumPaddingBits_1,
                                            literal_2, kNumBytesPerCode_2, kNumPaddingBits_2,
                                            literal_3, kNumBytesPerCode_3, kNumPaddingBits_3,
                                            literal_4, kNumBytesPerCode_4, kNumPaddingBits_4
								         ); 
	  else if (p_s_model == 11)
        four_columns_cmp_with_literal_pf_or_P_S(data_, bitvector, T1_len, 
                                            literal_1, kNumBytesPerCode_1, kNumPaddingBits_1,
                                            literal_2, kNumBytesPerCode_2, kNumPaddingBits_2,
                                            literal_3, kNumBytesPerCode_3, kNumPaddingBits_3,
                                            literal_4, kNumBytesPerCode_4, kNumPaddingBits_4
