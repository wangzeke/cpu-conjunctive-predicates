...
#define FIVETH_COMPARISON_TYPE Comparator::kGreater
								  ...
								  ) 
{
    ...
    AvxUnit mask_literal_5[kNumBytesPerCode_4];
    literal_5 <<= kNumPaddingBits_5;
    ...
    for(size_t byte_id=0; byte_id < kNumBytesPerCode_5; byte_id++){
		 ByteUnit byte           = FLIP(static_cast<ByteUnit>(literal_5 >> 8*(kNumBytesPerCode_5 - 1 - byte_id)));
    ...
    for(size_t offset = 0, bv_word_id = 0; offset < len; offset += NUM_WORD_BITS, bv_word_id++)
	{
		...
		{  
           ...
           // bool move_to_next_segment = true;
            ...
            computeKernelWithMask_FIRST<FIVETH_COMPARISON_TYPE>(avx_load( (void *)(data_5[0]+offset+i)),
                                                          mask_literal_5[0],
                                                          m_less_5,
                                                          m_greater_5,
                                                          m_equal_5,
		  ...
		  {      
			...
			if ( (kNumBytesPerCode_5 > 1) && !avx_iszero( m_equal_5) ) //for the remaining segments of predicate 5.
			{
				ByteUnit *addr_tmp   = data_5[1] + offset + i;
					
                tmpA                 =  avx_load( (void *)addr_tmp ); 
                tmpB                 =  mask_literal_5[1];
                computeKernelWithMask<FIVETH_COMPARISON_TYPE>(tmpA,
                                                             tmpB,
                                                             m_less_5,
                                                             m_greater_5,
                                                             m_equal_5,
                                                             m_success_5,
                                                             m_fail_5);
		    	if ( (kNumBytesPerCode_5 > 2) && !avx_iszero( m_equal_5) )//for the third segment of predicate 1.
		    	{
		    		ByteUnit *addr_tmp   =  data_5[2] + offset + i;
                    tmpA                 =  avx_load( (void *)addr_tmp ); 
                    tmpB                 =  mask_literal_5[2];
                    computeKernelWithMask<FIVETH_COMPARISON_TYPE>(tmpA,
                                                                 tmpB,
                                                                 m_less_5,
                                                                 m_greater_5,
                                                                 ...
                                                                 m_success_5,
                                                                 m_fail_5);		
		        	if ( (kNumBytesPerCode_5 > 3) && !avx_iszero(m_equal_5) )//for the fourth segment of predicate 1.
		        	{
		        		ByteUnit *addr_tmp   =  data_5[3] + offset + i;
                        tmpA                 =  avx_load( (void *)addr_tmp );
                        tmpB                 =  mask_literal_5[3];
                        computeKernelWithMask<FIVETH_COMPARISON_TYPE>(tmpA,
                                                                     tmpB,
                                                                     m_less_5,
                                                                     m_greater_5,
            ...
            //AvxUnit m_result         = avx_and(m_less_2, m_greater_1);
               ...
               computeMask_one_predicate<FOURTH_COMPARISON_TYPE>(
                                 ...
                                 m_less_4,
			                     m_result_4 );		
               computeMask_one_predicate<FIVETH_COMPARISON_TYPE>(
							     m_equal_5,
                                 m_greater_5,
                                 m_less_5,
			                     m_result_5 );									 
