#!/bin/bash
#echo $1    share the same executionalble file of normal conjunctive predicates.
...
do
  ...
  echo "With threads:" $i >>$1
		...
		do
          ...
          ./4_column_compare_with_literal_test.x $i 1 17 17 17 17 0 5 5 0.9 0.8 0.7 $j >result.txt
